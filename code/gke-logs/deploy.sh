...
BUCKET_NAME=YOUR_BUCKET # Where the GKE logs are stored
REGION=us-central1 # Region where the function will be deployed
TRIGGER_LOCATION=us # {us|eu|asia} - Location of the bucket
SOURCE_URL=gs://streamsec-production-public-artifacts/gcp-gke-logs-collection.zip # URL of the public GCS file
RUNTIME=nodejs22
